...
FIXED. All four named screens now carry the systemic mobile-gutter fix, each documented inline as
"carried forward from 06-01" or "applied proactively": `lib/onboarding/existing_wallet/view/legal_screen.dart:29`,
`lib/onboarding/existing_wallet/view/select_wallet_type_screen.dart:34`,
`lib/onboarding/existing_wallet/view/import_security_screen.dart:104`, and
`lib/screens/pin_screen.dart:38`.
