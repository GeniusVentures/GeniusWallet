...
STALE. The todo's own "Solution" section never named concrete target padding/spacing values (it
says "TBD"), and the three files it lists (`account_dropdown_selector.dart`, `gw_dialog.dart`,
`bottom_drawer.dart`) have all been rebuilt multiple times since 2026-07-18 without anyone
revisiting this specific polish request. There is nothing left here to act on.
