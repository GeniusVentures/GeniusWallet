...
STALE. The todo's own body already carries a "RESOLVED 2026-07-22 — superseded by
FRESH-INSTALL-RECIPE.md" note, recorded at the time the follow-up doc was written. The file was
simply never moved to `completed/` afterward.
