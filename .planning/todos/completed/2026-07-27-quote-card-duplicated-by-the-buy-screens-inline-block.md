...
FIXED. `lib/banxa/banxa_components/quote_card.dart` was deleted outright in commit `8c172866`, and
`grep -rn "QuoteCard(" lib/` finds no remaining callers — the duplicated component is gone rather
than reconciled with the inline block.
