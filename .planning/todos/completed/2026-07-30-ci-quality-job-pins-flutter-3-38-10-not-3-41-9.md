...
FIXED. `.github/workflows/build.yml:371` and `:1394` both now pin `flutter-version: 3.41.9`, and
the quality job has since run for real on PR #235 rather than staying an untested pin.
