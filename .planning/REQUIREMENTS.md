...
| SCR-05 | Phase 9 — Banxa | In progress (09-01: test/banxa/ floor + shared order-status ladder landed; 09-02: orders list + card re-skinned; 09-03: buy screen + quote_card re-skinned; 09-04: order details card/page re-skinned; 09-05: checkout_qr.dart + handle_banxa_drawer.dart re-skinned, finding 6 stays OUTSTANDING; box stays unchecked until phase verification — this phase does not deliver the real KYC redirect URL per 09-CONTEXT.md D-02 scope reduction, mirroring SCR-04's per-plan pattern; the checkbox above was mistakenly checked by 09-04's docs commit and is corrected here) |
| GAP-05 | Phase 9 — Banxa | In progress (09-02: `banxa_orders_history.dart` + `order_card.dart` re-skinned and closed; 09-03: `screens/banxa_buy_screen.dart` re-skinned and closed; `banxa_payment.dart` still pending a later plan; box stays unchecked until all three named files are done) |
