                        ...
                        children: [
                          ...
                          _buildDropdown<Coin>(
                              ...
                              onItemChanged: (Coin newCoin) {
                                setState(() {
                                  fromToken =
                                      newCoin; // Update the selected coin
                                });
                              },
                          ...
                          _buildDropdown<Network>(
                            availableItems:
                                availableBridgeNetworks ?? List.empty(),
                            onItemChanged: (Network newNetwork) {
                              setState(() {
                                toNetwork =
                                    newNetwork; // Update the selected coin
                              });
                            },
                            displayText: (Network network) =>
                                network.name ?? '',
                            ...
                            onAmountChanged:
                                null, // Disable manual input for "To"
                          ...
                          TextButton(
                            onPressed:
                                fromAmountController.text.isEmpty || isError
                                    ? null
                                    : () async {
                                        final api = context.read<GeniusApi>();
                                        ...
                                        showDialog(
                                          ...
                                          builder: (_) => AlertDialog(
                                            backgroundColor: GeniusWalletColors
                                                .deepBlueCardColor,
                                            contentPadding:
                                                const EdgeInsets.symmetric(
                                                    horizontal: 18,
                                                    vertical: GeniusWalletConsts
                                                        .space10),
                                            actionsAlignment:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                Text(
                                                                                  ...
                                                                                  maxLines: 2, // Allows wrapping on small screens
                                                                                  overflow: TextOverflow.ellipsis,
                                                                                  softWrap: true,
