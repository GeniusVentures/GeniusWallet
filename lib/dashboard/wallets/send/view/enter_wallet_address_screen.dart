    ...
    return Scaffold(
      body: LayoutBuilder(builder: (context, constraints) {
        if (GeniusBreakpoints.useDesktopLayout(context)) {
          return const _EnterWalletAddressScreenDesktop();
        }
        return const _EnterWalletAddressScreenMobile();
      }),
    );
  }
}

class _EnterWalletAddressScreenMobile extends StatelessWidget {
  const _EnterWalletAddressScreenMobile({
    Key? key,
  }) : super(key: key);
...
class _EnterWalletAddressScreenDesktop extends StatelessWidget {
  const _EnterWalletAddressScreenDesktop({
    Key? key,
  }) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return AppScreenDesktop(title: 'Send Bitoin', bodyWidgets: [
