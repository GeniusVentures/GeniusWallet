...
class NavDashboard extends StatefulWidget {
  ...
  @override
  _NavDashboard createState() => _NavDashboard();
}

class _NavDashboard extends State<NavDashboard> {
  _NavDashboard();
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        child: Stack(children: [
          Positioned(
            left: 0,
            width: widget.constraints.maxWidth * 1.001,
            top: 0,
            ...
            child: Stack(children: [
              ...
              Positioned(
                ...
                child: NavDashboardButtonCustom(
                  ...
                  'assets/images/navdashboardbuttoncustom.svg',
                  package: 'genius_wallet',
                  height: 15.710205078125,
                  width: 15.2001953125,
                  fit: BoxFit.none,
                )),
              ),
              Positioned(
                ...
                child: widget.ovrGeniusAppbarLogo ??
                    Image.asset(
                      ...
                      width: widget.constraints.maxWidth * 0.4222222222222222,
                      fit: BoxFit.fill,
                    ),
              ),
              Positioned(
                ...
                width: widget.constraints.maxWidth * 1.0,
                top: widget.constraints.maxHeight * 0.132,
              ...
              Positioned(
                ...
                child: NavWalletButtonCustom(
                  ...
                  width: widget.constraints.maxWidth * 0.1688910590277778,
                  fit: BoxFit.fill,
                )),
              ),
              Positioned(
              ...
              Positioned(
                ...
                child: NavTimerButtonCustom(
                  ...
                  width: widget.constraints.maxWidth * 0.16005859375,
                  fit: BoxFit.fill,
                )),
              ),
              Positioned(
                ...
                child: NavCalculatorButtonCustom(
                  ...
                  package: 'genius_wallet',
                  height: widget.constraints.maxHeight * 0.01396606773164727,
                  width: widget.constraints.maxWidth * 0.1677734375,
                  fit: BoxFit.fill,
                )),
              ),
              Positioned(
              ...
              Positioned(
                ...
                child: NavNewsButtonCustom(
                  ...
                  package: 'genius_wallet',
                  height: widget.constraints.maxHeight * 0.01360783453166965,
                  width: widget.constraints.maxWidth * 0.1668185763888889,
                  fit: BoxFit.fill,
                )),
              ),
              Positioned(
                left: widget.constraints.maxWidth * 0.301,
                width: widget.constraints.maxWidth * 0.456,
                top: widget.constraints.maxHeight * 0.612,
