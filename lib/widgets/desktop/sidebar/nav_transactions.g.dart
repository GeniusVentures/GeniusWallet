...
class NavTransactions extends StatefulWidget {
  ...
  @override
  _NavTransactions createState() => _NavTransactions();
}

class _NavTransactions extends State<NavTransactions> {
  _NavTransactions();
