...
import 'package:genius_wallet/widgets/desktop/custom/transactionflow_outgoing_custom.dart';
import 'package:genius_wallet/widgets/desktop/custom/harmburger_menu_custom.dart';
import 'package:flutter_svg/flutter_svg.dart';
import 'package:auto_size_text/auto_size_text.dart';

class TransactionflowOutgoing extends StatefulWidget {
  ...
  @override
  _TransactionflowOutgoing createState() => _TransactionflowOutgoing();
}

class _TransactionflowOutgoing extends State<TransactionflowOutgoing> {
  _TransactionflowOutgoing();

  @override
  Widget build(BuildContext context) {
    return Container(
        decoration: BoxDecoration(),
        child: TransactionflowOutgoingCustom(
