...
class Property1NavbarTransactions extends StatefulWidget {
  ...
  const Property1NavbarTransactions(
    this.constraints, {
    Key? key,
    this.ovrWallets,
    this.ovrVector,
  ...
  @override
  _Property1NavbarTransactions createState() => _Property1NavbarTransactions();
}

class _Property1NavbarTransactions extends State<Property1NavbarTransactions> {
  _Property1NavbarTransactions();
