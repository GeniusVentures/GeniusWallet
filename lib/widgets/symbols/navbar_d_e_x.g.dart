  ...
  Widget build(BuildContext context) {
    return Stack(children: [
      ...
      Positioned(
        ...
        child: Image.asset(
          ovrShield ?? 'assets/images/0_12401.png',
      ...
      Positioned(
        ...
        child: Image.asset(
          'assets/images/115_4107.png',
          width: constraints.maxWidth * 25.000,
          height: constraints.maxHeight * 5.774,
        ),
      ),
      Positioned(
