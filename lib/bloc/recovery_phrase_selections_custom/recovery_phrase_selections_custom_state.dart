abstract class RecoveryPhraseSelectionsCustomState {
  RecoveryPhraseSelectionsCustomState();
}
...
class RecoveryPhraseSelectionsCustomInitial
    extends RecoveryPhraseSelectionsCustomState {
  RecoveryPhraseSelectionsCustomInitial() : super();
}
