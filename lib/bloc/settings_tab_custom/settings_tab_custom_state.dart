abstract class SettingsTabCustomState {
  SettingsTabCustomState();
}
...
class SettingsTabCustomInitial extends SettingsTabCustomState {
  SettingsTabCustomInitial() : super();
}
