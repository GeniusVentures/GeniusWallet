abstract class RecipientAddressCustomState {
  RecipientAddressCustomState();
}
...
class RecipientAddressCustomInitial extends RecipientAddressCustomState {
  RecipientAddressCustomInitial() : super();
}
