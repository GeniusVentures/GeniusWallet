abstract class CrytoDetailsScrollViewCustomState {
  CrytoDetailsScrollViewCustomState();
}
...
class CrytoDetailsScrollViewCustomInitial
    extends CrytoDetailsScrollViewCustomState {
  CrytoDetailsScrollViewCustomInitial() : super();
}
