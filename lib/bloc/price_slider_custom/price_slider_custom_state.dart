abstract class PriceSliderCustomState {
  PriceSliderCustomState();
}
...
class PriceSliderCustomInitial extends PriceSliderCustomState {
  PriceSliderCustomInitial() : super();
}
