...
if(NOT CMAKE_SKIP_THIRD_PARTY)
    ...
    set(OpenSSL_DIR "${THIRDPARTY_BUILD_DIR}/openssl/build/${CMAKE_SYSTEM_NAME}${ABI_SUBFOLDER_NAME}/lib/cmake/OpenSSL" CACHE PATH "Path to OpenSSL install folder")
    ...
    set(OPENSSL_ROOT_DIR "${THIRDPARTY_BUILD_DIR}/openssl/build/${CMAKE_SYSTEM_NAME}${ABI_SUBFOLDER_NAME}" CACHE PATH "Path to OpenSSL install root folder")
