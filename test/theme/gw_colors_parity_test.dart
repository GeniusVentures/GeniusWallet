...
void main() {
  group('Field-count drift guard', () {
    test(
      'GWColors declares exactly 66 fields (21 pre-existing + 43 from the 23-01 token map + statusWarningText from the 23-03 follow-up + textMutedOnSunken from the control-track AA fix)',
      () {
