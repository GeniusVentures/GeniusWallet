...
void main() {
  group('sdkRowActions', () {
    ...
    test('the active account imported from a private key: no phrase, no QR', () {
    ...
    test('any other account: delete only, never the phrase', () {
      ...
      expect(can.payout, isFalse, reason: 'payout applies to the active account');
  ...
  group('isEvmAddress', () {
    test('accepts a real address in either case', () {
      expect(isEvmAddress('0x71C7656EC7ab88b098defB751B7401B5f6d8976F'), isTrue);
      expect(isEvmAddress('0x71c7656ec7ab88b098defb751b7401b5f6d8976f'), isTrue);
      // Surrounding whitespace is a paste artefact, not a mistake.
      expect(isEvmAddress('  0x71c7656ec7ab88b098defb751b7401b5f6d8976f  '),
          isTrue);
    });
    ...
    test('refuses the shapes the field used to post straight to the SDK', () {
      ...
      expect(isEvmAddress('0x71c7656ec7ab88b098defb751b7401b5f6d8976'), isFalse);
      // One too long.
      expect(
          isEvmAddress('0x71c7656ec7ab88b098defb751b7401b5f6d8976ff'), isFalse);
      ...
      expect(isEvmAddress('0x71c7656ec7ab88b098defb751b7401b5f6d8976z'), isFalse);
    });
  });
}
