...
class UTXO extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UTXO', package: const $pb.PackageName(_omitMessageNames ? '' : 'SGTransaction'), createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'outputIdx', $pb.PbFieldType.OU3)
    ...
    ..a<$core.List<$core.int>>(4, _omitFieldNames ? '' : 'token', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set outputIdx($core.int v) { $_setUnsignedInt32(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasOutputIdx() => $_has(0);
  @$pb.TagNumber(1)
  void clearOutputIdx() => clearField(1);
...
class UTXOList extends $pb.GeneratedMessage {
  ...
  UTXOList._() : super();
  factory UTXOList.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UTXOList.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UTXOList', package: const $pb.PackageName(_omitMessageNames ? '' : 'SGTransaction'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UTXOList clone() => UTXOList()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UTXOList copyWith(void Function(UTXOList) updates) => super.copyWith((message) => updates(message as UTXOList)) as UTXOList;
  ...
  static $pb.PbList<UTXOList> createRepeated() => $pb.PbList<UTXOList>();
  @$core.pragma('dart2js:noInline')
  static UTXOList getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UTXOList>(create);
...
class MintTxV2 extends $pb.GeneratedMessage {
  ...
  MintTxV2._() : super();
  factory MintTxV2.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory MintTxV2.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MintTxV2', package: const $pb.PackageName(_omitMessageNames ? '' : 'SGTransaction'), createEmptyInstance: create)
    ..aOM<DAGStruct>(1, _omitFieldNames ? '' : 'dagStruct', subBuilder: DAGStruct.create)
    ..a<$core.List<$core.int>>(2, _omitFieldNames ? '' : 'chainId', $pb.PbFieldType.OY)
    ..a<$core.List<$core.int>>(3, _omitFieldNames ? '' : 'tokenId', $pb.PbFieldType.OY)
    ..a<$fixnum.Int64>(4, _omitFieldNames ? '' : 'amount', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..aOM<UTXOTxParams>(5, _omitFieldNames ? '' : 'utxoParams', subBuilder: UTXOTxParams.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  MintTxV2 clone() => MintTxV2()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MintTxV2 copyWith(void Function(MintTxV2) updates) => super.copyWith((message) => updates(message as MintTxV2)) as MintTxV2;
  ...
  static $pb.PbList<MintTxV2> createRepeated() => $pb.PbList<MintTxV2>();
  @$core.pragma('dart2js:noInline')
  static MintTxV2 getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<MintTxV2>(create);
  ...
  @$pb.TagNumber(5)
  set utxoParams(UTXOTxParams v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasUtxoParams() => $_has(4);
  @$pb.TagNumber(5)
  void clearUtxoParams() => clearField(5);
  @$pb.TagNumber(5)
