...
mixin _$SGNUSConnection {
 ...
 String get sgnusAddress; String get walletAddress; bool get isConnected;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SGNUSConnection&&(identical(other.sgnusAddress, sgnusAddress) || other.sgnusAddress == sgnusAddress)&&(identical(other.walletAddress, walletAddress) || other.walletAddress == walletAddress)&&(identical(other.isConnected, isConnected) || other.isConnected == isConnected));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,sgnusAddress,walletAddress,isConnected);
...
@useResult
$Res call({
 String sgnusAddress, String walletAddress, bool isConnected
});
...
/// Create a copy of SGNUSConnection
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? sgnusAddress = null,Object? walletAddress = null,Object? isConnected = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String sgnusAddress,  String walletAddress,  bool isConnected)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SGNUSConnection() when $default != null:
return $default(_that.sgnusAddress,_that.walletAddress,_that.isConnected);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String sgnusAddress,  String walletAddress,  bool isConnected)  $default,) {final _that = this;
switch (_that) {
case _SGNUSConnection():
return $default(_that.sgnusAddress,_that.walletAddress,_that.isConnected);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String sgnusAddress,  String walletAddress,  bool isConnected)?  $default,) {final _that = this;
switch (_that) {
case _SGNUSConnection() when $default != null:
return $default(_that.sgnusAddress,_that.walletAddress,_that.isConnected);case _:
  return null;
...
class _SGNUSConnection implements SGNUSConnection {
  const _SGNUSConnection({required this.sgnusAddress, required this.walletAddress, required this.isConnected});
...
/// Create a copy of SGNUSConnection
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? sgnusAddress = null,Object? walletAddress = null,Object? isConnected = null,}) {
