...
mixin _$Token {
 ...
 String? get address; String? get iconPath; String? get name; String? get coinGeckoId; String? get id;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,address,iconPath,name,coinGeckoId,id);
...
@useResult
$Res call({
 String? address, String? iconPath, String? name, String? coinGeckoId, String? id
});
...
/// Create a copy of Token
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? address = freezed,Object? iconPath = freezed,Object? name = freezed,Object? coinGeckoId = freezed,Object? id = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? address,  String? iconPath,  String? name,  String? coinGeckoId,  String? id)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Token() when $default != null:
return $default(_that.address,_that.iconPath,_that.name,_that.coinGeckoId,_that.id);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? address,  String? iconPath,  String? name,  String? coinGeckoId,  String? id)  $default,) {final _that = this;
switch (_that) {
case _Token():
return $default(_that.address,_that.iconPath,_that.name,_that.coinGeckoId,_that.id);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? address,  String? iconPath,  String? name,  String? coinGeckoId,  String? id)?  $default,) {final _that = this;
switch (_that) {
case _Token() when $default != null:
return $default(_that.address,_that.iconPath,_that.name,_that.coinGeckoId,_that.id);case _:
  return null;
...
class _Token implements Token {
  const _Token({this.address, this.iconPath, this.name, this.coinGeckoId, this.id});
...
/// Create a copy of Token
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? address = freezed,Object? iconPath = freezed,Object? name = freezed,Object? coinGeckoId = freezed,Object? id = freezed,}) {
  return _then(_Token(
address: freezed == address ? _self.address : address // ignore: cast_nullable_to_non_nullable
as String?,iconPath: freezed == iconPath ? _self.iconPath : iconPath // ignore: cast_nullable_to_non_nullable
as String?,name: freezed == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
